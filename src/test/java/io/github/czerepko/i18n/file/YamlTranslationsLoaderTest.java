...
class YamlTranslationsLoaderTest {

    private YamlTranslationsLoader loader = new YamlTranslationsLoader();
    ...
    void tryToGetTranslationsForDirectoryWithInvalidFileFormat() {
        ...
        assertThat(exception.getMessage(), is(equalTo("File i18n/invalid_file_format/i18n.yaml has invalid format")));
    }
